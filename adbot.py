...
DEFAULT_CONFIG = {
    "host_usernames": ["@0.167"],
    "admin_usernames": ["@0.167"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
    ...
    "announcement_message": "برای اجاره بات به آیدی @0.167 پیام دهید!"
}
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a65312fa84efb842e00ec21")
